...
SITUATION_TYPES = (
    ...
    "ACTION_FOLLOW_UP", "SLA_COMMITMENT_RISK",
)
...
class OipProjectionState(db.Model):
    ...
    last_evaluation_attempt_at = db.Column(db.DateTime(timezone=True))
    last_evaluation_success_at = db.Column(db.DateTime(timezone=True))
    next_evaluation_due_at = db.Column(db.DateTime(timezone=True))
