...
def traceability_app():
    ...
    with app.app_context():
        ...
        db.session.flush()
        active = OperationalShipment(public_id="shipment-active", organization_id=org.id, project_id=project.id, source_type="direct", customer_id=customer.id, lifecycle_status="in_progress", created_by_user_id=user.id, primary_responsible_expert_id=user.id)
        terminal = OperationalShipment(public_id="shipment-terminal", organization_id=org.id, project_id=project.id, source_type="direct", customer_id=customer.id, lifecycle_status="completed", created_by_user_id=user.id, primary_responsible_expert_id=user.id)
        no_location = OperationalShipment(public_id="shipment-no-location", organization_id=org.id, project_id=project.id, source_type="direct", customer_id=customer.id, lifecycle_status="planned", created_by_user_id=user.id, primary_responsible_expert_id=user.id)
