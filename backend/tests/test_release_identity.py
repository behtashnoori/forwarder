...
def identity_app(tmp_path):
    ...
    manifest.write_text(json.dumps({
        "application_version": "1.9.1", "git_tag": "v1.9.1",
...
def test_release_identity_requires_auth_and_minimizes_normal_projection(identity_app):
    ...
    assert response.json == {"data": {"application_version": "1.9.1"}, "projection": "normal"}
...
def test_release_identity_support_projection_is_explicitly_allowlisted(identity_app):
    ...
    assert response.json["data"] == {
        "application_version": "1.9.1", "frontend_version": "1.9.1", "backend_version": "1.9.1",
        "release_tag": "v1.9.1", "short_commit": "1234567890ab",
        "database_revision": "20260819_v191_acceptance_corrections",
    }
