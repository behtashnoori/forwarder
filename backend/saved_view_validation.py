...
MAX_JSON = 128 * 1024
MAX_FILTERS = 12
ALLOWED_COLUMNS = {"CUSTOMER", "ROUTE", "PLANNED_TIME", "PROJECT", "SOURCE", "MILESTONE", "OPEN_WORK_ITEMS", "SHIPMENT_STATUS"}
ALLOWED_SORT = {"PLANNED_DEPARTURE", "PLANNED_ARRIVAL", "CREATED_AT", "SHIPMENT_STATUS"}
