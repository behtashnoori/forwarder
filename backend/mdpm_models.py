...
class OperationalDocumentRequirement(db.Model):
    ...
    source_project_requirement_id = db.Column(BIGINT, db.ForeignKey("project_document_requirement.id", ondelete="RESTRICT"), nullable=False)
    source_project_requirement_public_id = db.Column(db.String(36), nullable=False)
    source_project_requirement_version = db.Column(db.Integer, nullable=False)
    ...
    target_milestone_type = db.Column(db.String(64), nullable=False)
