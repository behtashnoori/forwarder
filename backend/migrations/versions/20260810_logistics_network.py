...
def upgrade():
    ...
    op.create_index(
        "ix_logistics_point_type_active_order",
        "logistics_point_type",
    ...
    op.create_table(
        ...
        sa.Column("immutable_code", sa.String(64), nullable=False),
        sa.Column("logistics_point_type_id", BIGINT, nullable=False),
        sa.Column("fa_name", sa.String(160), nullable=False),
        sa.Column("normalized_name", sa.String(200), nullable=False),
        sa.Column("en_name", sa.String(160)),
        sa.Column("country_id", BIGINT, nullable=False),
        sa.Column("province_id", BIGINT),
        sa.Column("city_id", BIGINT),
        sa.Column("geography_key", sa.String(200), nullable=False),
    ...
    op.create_index(
        "ix_logistics_point_org_active",
        "logistics_point",
        ["organization_id", "is_active"],
    )
    op.create_index(
        "ix_logistics_point_org_type",
        "logistics_point",
        ["organization_id", "logistics_point_type_id"],
    )
    op.create_index(
        "ix_logistics_point_org_name",
        "logistics_point",
    ...
    op.create_index(
        ...
        "logistics_point",
        ["organization_id", "country_id", "province_id", "city_id"],
    )
    op.create_index(
        "ix_logistics_point_org_updated",
        "logistics_point",
    ...
    op.create_table(
        ...
        sa.Column("logistics_point_id", BIGINT, nullable=False),
    ...
    op.create_index(
        ...
        "project_logistics_point",
        ["project_id", "is_active", "sequence_number"],
    )
...
def downgrade():
    op.drop_index(
        "ix_project_logistics_point_project_active",
        table_name="project_logistics_point",
    )
    op.drop_index(
        "uq_project_logistics_point_active_sequence",
        table_name="project_logistics_point",
    ...
    op.drop_index(
        "ix_logistics_point_type_active_order", table_name="logistics_point_type"
    )
