...
def upgrade() -> None:
    ...
    op.create_table(
        "shipment_request",
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("origin_province_id", sa.Integer(), nullable=False),
        sa.Column("origin_county_id", sa.Integer(), nullable=False),
        sa.Column("origin_city_id", sa.Integer(), nullable=False),
        sa.Column("dest_province_id", sa.Integer(), nullable=False),
        sa.Column("dest_county_id", sa.Integer(), nullable=False),
        sa.Column("dest_city_id", sa.Integer(), nullable=False),
