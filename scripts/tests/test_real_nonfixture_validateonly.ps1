...
$xml='<Task><Actions><Exec><Command>C:\Windows\System32\cmd.exe</Command><Arguments>/d /c &quot;&quot;'+$python+'&quot; &quot;C:\1-webapp\forwarder-runtime\phase1b_production_cutover_runtime.py&quot; serve --env &quot;C:\1-webapp\forwarder-runtime\production.env&quot; --repo &quot;'+$release+'&quot; --host 127.0.0.1 --port 5101 --log &quot;C:\1-webapp\forwarder-runtime\waitress.log&quot;&quot;</Arguments><WorkingDirectory>'+$release+'</WorkingDirectory></Exec></Actions></Task>'
...
'@
    ...
    Reset-Topology;$topology.Xml=$xml.Replace('phase1b_production_cutover_runtime.py','unapproved.py');Assert-Topology 'Wrong_task_launcher' 'approved runtime launcher required'
    ...
    Reset-Topology;$topology.Xml=$xml.Replace('--repo &quot;'+$release+'&quot;','--repo &quot;C:\another-release&quot;');Assert-Topology 'Wrong_repo' 'runtime/--repo mismatch'
    ...
    Reset-Topology;$topology.Xml=$xml.Replace('/d /c &quot;&quot;','/d /c &quot;').Replace('waitress.log&quot;&quot;','waitress.log&quot;');Assert-Topology 'Cmd_without_outer_quote_pair'
