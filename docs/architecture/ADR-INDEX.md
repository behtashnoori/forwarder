...
2026-09-16 M1 acceptance: [ADR-048 Amendment M1 proposal](../operational/evidence/fwd-06-tracking-timeline/ADR-048-AMENDMENT-M1-MANUAL-TIME-PROPOSED.md), SHA256 `6792ADD2CC064A73977386D62263EDA13A0C534CE5A7E118679A1422CD55673A`, accepted for local FWD-06 only. The limited manual Tehran exception to TIME-BIZ-007/011 and five-column additive migration modify only ADR-048's conflicting time/schema effects. Original proposal and prior acceptance remain bound to their own historical bytes. [M1 acceptance record](../operational/evidence/fwd-06-tracking-timeline/ADR-048-AMENDMENT-M1-ACCEPTANCE-2026-09-16.md).

## FWD-07 recovery proposal

| ADR | Title | Status | Domain | Implementation authority |
| --- | --- | --- | --- | --- |
| [049](../operational/adr/ADR-049-request-document-upload-operation-recovery.md) | Request document upload operation recovery | PROPOSED | Request documents / byte-storage consistency / recovery receipts | NONE; named Owner acceptance and separate implementation authority required |
