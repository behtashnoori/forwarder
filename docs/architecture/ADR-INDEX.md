...
| [047](../operational/adr/ADR-047-fixed-operational-shipment-responsible-expert.md) | Fixed Responsible Transport Expert per Operational Shipment | ACCEPTED | Shipment authorization | scoped supersession of ADR-042/043 / none | target convergence on Shipment-owned fixed responsibility; implementation pending | Yes; no implementation authority |
