...
| WorkItem | operations / operational_service | OperationalWorkItem | list/action | shipment / work-item shipment FK | yes | UNSAFE_GAP |
| RoutePlan/RouteLeg | operations / route orchestration | route resources | list/detail/action | shipment / plan/leg FK | yes | UNSAFE_GAP |
| Checkpoint/Milestone | operations / route orchestration | checkpoint/milestone | list/action | shipment / declared FK | yes | UNSAFE_GAP |
...
| Route exceptions | operations / route orchestration | exception | list/detail/action | shipment FK | yes | UNSAFE_GAP |
