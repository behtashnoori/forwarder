...
$evidence = 'D:\1-webapp\forwarder-dev\p313-qualification-c091490-20260926\static'
New-Item -ItemType Directory -Force -Path $evidence | Out-Null
$source = (git rev-parse HEAD).Trim()
if ($source -ne 'c0914906af6675c016d5b77d51ecc8a0c05c0b72' -or (git status --porcelain)) { throw 'Source changed' }
$gates = @(
