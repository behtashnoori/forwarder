...
| --- | --- | --- | --- |
| [Operational Shipment Product Contract v1](../product/FORWARDER-OPERATIONAL-SHIPMENT-PRODUCT-CONTRACT-V1-FA.md) | `ACTIVE / APPROVED_TARGET_PHASE3 / P3-01_CANDIDATE_ONLY` | Multi-customer/multi-cargo Shipment, quantities/allocation, route execution, privacy/tracking, delivery/closure and UX target | P3-01 implements only the bounded central-catalog/organization-activation foundation; the broader Product Contract remains target behavior and is not claimed implemented or accepted. Historical ADR/PDR text and the limited ADR-047 supersession remain preserved. |
...
| [Phase 3 Implementation Plan v1](../product/phase3/FORWARDER-PHASE3-IMPLEMENTATION-PLAN-V1-FA.md) | `ACTIVE / PLAN_READY / P3-01_STARTED_ONLY` | 15 bounded slices with explicit Product gates, source-based reuse, migration, privacy/history and qualification plans | The planning-time body remains historical. The Product Owner later authorized P3-01 only; P3-02 through P3-15 remain not started by that authority. |
| [P3-01 Reference Catalog Mission Contract](../product/phase3/P3-01-REFERENCE-CATALOG-MISSION-CONTRACT-FA.md) | `ACTIVE_IMPLEMENTATION_MISSION / P3-01_ONLY` | Central reference definitions, organization activation, approved CargoType/UOM Expert consumption, history and tenant boundaries | Explicit start authority for P3-01 only; `DN08` organization-specific creation/promotion remains open and excluded. |
...
| [P3-02 Cargo Lineage Mission Contract](../product/phase3/P3-02-CARGO-LINEAGE-MISSION-CONTRACT-FA.md) | `ACTIVE_IMPLEMENTATION_MISSION / P3-02_ONLY` | Per-Cargo Customer, optional Request lineage, explicit quantity meanings, governed Packaging, progressive detail and auditable correction | Explicit Product Owner start authority for P3-02 followed by P3-03; P3-03 cannot begin until P3-02 is fully qualified and canonically integrated. |
...
| ADR-057 | Cargo Customer/Request Lineage and Quantity Semantics | Accepted — P3-02 bounded implementation | Operational Shipment Cargo | 2026-09-25 | Phase 3 P3-02 candidate | Existing ShipmentCargoItem SOR extended with exact Customer, optional Request/RequestCargo source, independent requested/planned/actual values, Packaging and progressive detail; legacy unknown remains unknown | [ADR-057](adr/ADR-057-cargo-customer-request-lineage-and-quantity-semantics.md) | Extends ADR-022; consumes ADR-056; preserves ADR-043/046/047 | Exact-candidate qualification/integration pending; no Customer projection, new lifecycle, UOM conversion, route, release, deployment or Production authority |
