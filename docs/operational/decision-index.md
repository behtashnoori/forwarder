...
| [Phase 3 Implementation Plan v1](../product/phase3/FORWARDER-PHASE3-IMPLEMENTATION-PLAN-V1-FA.md) | `ACTIVE / PLAN_READY / P3-03_QUALIFIED_AWAITING_INTEGRATION` | 15 bounded slices with explicit Product gates, source-based reuse, migration, privacy/history and qualification plans | The planning-time body remains historical. Later Product authority integrated P3-01/P3-02 and qualified P3-03; it does not authorize P3-04 or later slices. |
...
| [P3-03 Branched Route Mission Contract](../product/phase3/P3-03-BRANCHED-ROUTE-MISSION-CONTRACT-FA.md) | `QUALIFIED_AWAITING_CANONICAL_INTEGRATION / P3-03_ONLY` | Progressive planned route, shared/branched destinations, Cargo branch association, actual traversal and replan history | Qualified at Product SHA `d7ff7208fdc25caff7af86379fd8afc5b41b24aa`; P3-04 and later work remain prohibited. |
...
| ADR-058 | Branched Planned Route and Separate Actual Traversal | Accepted — P3-03 bounded implementation | Operational Shipment Route | 2026-09-25 | Phase 3 P3-03 qualified candidate | Existing RoutePlan/RouteLeg SOR extended with incomplete drafts, same-plan branches, Cargo terminal destinations and append-only actual traversal facts | [ADR-058](adr/ADR-058-branched-planned-route-and-actual-traversal.md) | Complements ADR-002/022/034/042/043/046/047/057; supersedes none | Qualified at Product SHA `d7ff7208fdc25caff7af86379fd8afc5b41b24aa`; integration is the next gate; P3-04 execution, ETA, P3-07 location semantics, Customer projection, release, deployment and Production excluded |
