...
2026-09-16 M1: Owner accepted the unchanged [ADR-048 Amendment M1 proposal](evidence/fwd-06-tracking-timeline/ADR-048-AMENDMENT-M1-MANUAL-TIME-PROPOSED.md), SHA256 `6792ADD2CC064A73977386D62263EDA13A0C534CE5A7E118679A1422CD55673A`, for local FWD-06 only. Its Tehran manual-input exception to TIME-BIZ-007/011 and five-column additive event migration supersede only the conflicting no-schema/time-input effects above. [Acceptance record](evidence/fwd-06-tracking-timeline/ADR-048-AMENDMENT-M1-ACCEPTANCE-2026-09-16.md). Implementation PASS remains pending.
