...
The previous blocked P3-06 evidence is historical. [Fresh P3-06 qualification](evidence/phase3-p3-06-dn10-requalification-status-20260925.md) passed on Product `0e65fd89882e23453d7c3bfe4d520cd7f44a6c32`; controlled canonical integration is authorized. P3-01..05 are already canonical. Later starts remain subject to this mission’s verified canonical/dependency gates.

| Reference | Status | Governing scope | Relationship to existing decisions |
| --- | --- | --- | --- |
| [Operational Shipment Product Contract v1](../product/FORWARDER-OPERATIONAL-SHIPMENT-PRODUCT-CONTRACT-V1-FA.md) | `ACTIVE / APPROVED_TARGET_PHASE3 / P3-01_THROUGH_05_INTEGRATED / P3-06_QUALIFIED` | Multi-customer/multi-cargo Shipment, quantities/allocation, route execution, privacy/tracking, delivery/closure and UX target | P3-01 through P3-05 are bounded integrated slices at canonical `bd3610c4016cf643b6243fb0490260ac49a8b92d`. P3-06 DN10 has passed fresh qualification; P3-07 through P3-10 are authorized only under the current mission dependency gates. Historical ADR/PDR text and the limited ADR-047 supersession remain preserved. |
