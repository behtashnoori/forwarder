...
| --- | --- | --- | --- |
| [Operational Shipment Product Contract v1](../product/FORWARDER-OPERATIONAL-SHIPMENT-PRODUCT-CONTRACT-V1-FA.md) | `ACTIVE / APPROVED_TARGET_PHASE3 / P3-01_P3-02_INTEGRATED / P3-03_CANDIDATE` | Multi-customer/multi-cargo Shipment, quantities/allocation, route execution, privacy/tracking, delivery/closure and UX target | P3-01 and P3-02 are bounded integrated slices. P3-03 is the current bounded candidate; P3-04 and the remaining broader Product Contract are not claimed implemented. Historical ADR/PDR text and the limited ADR-047 supersession remain preserved. |
...
| [Phase 3 Implementation Plan v1](../product/phase3/FORWARDER-PHASE3-IMPLEMENTATION-PLAN-V1-FA.md) | `ACTIVE / PLAN_READY / P3-03_AUTHORIZED_CURRENT_SLICE` | 15 bounded slices with explicit Product gates, source-based reuse, migration, privacy/history and qualification plans | The planning-time body remains historical. Later Product authority integrated P3-01/P3-02 and authorized P3-03; it does not authorize P3-04 or later slices. |
...
| [P3-03 Branched Route Mission Contract](../product/phase3/P3-03-BRANCHED-ROUTE-MISSION-CONTRACT-FA.md) | `ACTIVE_IMPLEMENTATION_MISSION / P3-03_ONLY` | Progressive planned route, shared/branched destinations, Cargo branch association, actual traversal and replan history | Explicit Product Owner authority for P3-03 after the P3-02 canonical gate; P3-04 and later work remain prohibited. |
...
| ADR-058 | Branched Planned Route and Separate Actual Traversal | Accepted — P3-03 bounded implementation | Operational Shipment Route | 2026-09-25 | Phase 3 P3-03 candidate | Existing RoutePlan/RouteLeg SOR extended with incomplete drafts, same-plan branches, Cargo terminal destinations and append-only actual traversal facts | [ADR-058](adr/ADR-058-branched-planned-route-and-actual-traversal.md) | Complements ADR-002/022/034/042/043/046/047/057; supersedes none | Exact-candidate qualification/integration pending; P3-04 execution, ETA, P3-07 location semantics, Customer projection, release, deployment and Production excluded |
