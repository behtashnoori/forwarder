...
| --- | --- | --- | --- |
| [Operational Shipment Product Contract v1](../product/FORWARDER-OPERATIONAL-SHIPMENT-PRODUCT-CONTRACT-V1-FA.md) | `ACTIVE / APPROVED_TARGET_PHASE3 / P3-01_THROUGH_05_INTEGRATED / P3-06_REQUALIFICATION` | Multi-customer/multi-cargo Shipment, quantities/allocation, route execution, privacy/tracking, delivery/closure and UX target | P3-01 through P3-05 are bounded integrated slices at canonical `bd3610c4016cf643b6243fb0490260ac49a8b92d`. P3-06 DN10 is undergoing fresh qualification; P3-07 through P3-10 are authorized only under the current mission dependency gates. Historical ADR/PDR text and the limited ADR-047 supersession remain preserved. |
...
| [P3-06 Document Contract](../product/phase3/P3-06-DOCUMENT-CONTEXT-VISIBILITY-CONTRACT-FA.md) | `DN10_REQUALIFICATION` | Exact-version contextual documents and explicit live own-Cargo entitlement | New runtime requires new evidence; previous blocked candidate is historical. |
