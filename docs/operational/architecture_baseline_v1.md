...
| Administrator-managed Reference Data | Installation and deployment include application, schema, and migrations only; empty catalogs are valid and authorized administrators create Reference Data through Admin UI | [ADR-028](adr/ADR-028-administrator-managed-reference-data.md) |
