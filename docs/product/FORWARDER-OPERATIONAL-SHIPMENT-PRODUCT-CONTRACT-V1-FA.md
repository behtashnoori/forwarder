...
تصمیم صریح P3-11: توقف هر بخش مسیر متعلق به نقطهٔ رسیدن آن است و فقط پیش از حرکت بعدی محاسبه می‌شود. ETA رسیدن به B توقف B را ندارد؛ ETA نقطهٔ بعد از B توقف کامل باقی‌ماندهٔ B را دارد، مگر پایان عملیات یا شروع حرکت بعدی با واقعیت مجاز ثابت شود. توقف مقصد نهایی وارد زمان رسیدن نمی‌شود. گذشت زمان، پیشرفت را ثابت نمی‌کند؛ ۰/۰ با زمان نامعلوم متفاوت است. [قرارداد اجرایی جاری](phase3/P3-11-ETA-CONTRACT.md).
