...
> **یادداشت وضعیت جاری (۲۰۲۶-۰۹-۲۵):** متن و وضعیت بالا رکورد تاریخی زمان تصویب طرح است. اختیار بعدی مالک محصول، P3-01 و P3-02 را کامل و canonically integrated کرده و P3-03 را در Product SHA `d7ff7208fdc25caff7af86379fd8afc5b41b24aa` qualified کرده است. [قرارداد مأموریت P3-03](P3-03-BRANCHED-ROUTE-MISSION-CONTRACT-FA.md)، ADR-058 و سند evidence مرز جاری‌اند؛ canonical integration گیت بعدی است و این یادداشت P3-04 یا Release/Production را مجاز نمی‌کند.
