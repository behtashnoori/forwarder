...
> **یادداشت وضعیت جاری (۲۰۲۶-۰۹-۲۵):** متن و وضعیت بالا رکورد تاریخی زمان تصویب طرح است. P3-01 تا P3-04 در canonical SHA `3d4564bad7df7a2ec5aade24132c74d9c1ad0015` یکپارچه‌اند. مالک محصول P3-05 و پس از ادغام موفق آن P3-06 را به‌ترتیب مجاز کرده است؛ [قرارداد مأموریت P3-05](P3-05-CARGO-ALLOCATION-MISSION-CONTRACT-FA.md)، ADR-060 و [وضعیت اجرای جاری](../../operational/evidence/phase3-p3-05-cargo-allocation-status-20260925.md) مرز کنونی‌اند. این یادداشت به P3-07، Release، Deployment یا Production اختیاری نمی‌دهد.
