...
> **یادداشت وضعیت جاری (۲۰۲۶-۰۹-۲۵):** متن و وضعیت بالا رکورد تاریخی زمان تصویب طرح است. اختیار بعدی مالک محصول، P3-01 را کامل و canonically integrated کرده و اکنون اجرای سریالی P3-02 سپس P3-03 را مجاز کرده است. [قرارداد مأموریت P3-02](P3-02-CARGO-LINEAGE-MISSION-CONTRACT-FA.md) و ADR-057 مرز اجرایی جاری‌اند؛ این یادداشت P3-04 یا Release/Production را مجاز نمی‌کند.
