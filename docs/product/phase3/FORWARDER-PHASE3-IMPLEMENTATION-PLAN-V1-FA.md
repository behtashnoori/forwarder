...
> **یادداشت وضعیت جاری (۲۰۲۶-۰۹-۲۵):** متن و وضعیت بالا رکورد تاریخی زمان تصویب طرح است. اختیار بعدی مالک محصول، P3-01 و P3-02 را کامل و canonically integrated کرده و P3-03 را از همان مبنای تازه آغاز کرده است. [قرارداد مأموریت P3-03](P3-03-BRANCHED-ROUTE-MISSION-CONTRACT-FA.md) و ADR-058 مرز اجرایی جاری‌اند؛ این یادداشت P3-04 یا Release/Production را مجاز نمی‌کند.
