...
> **یادداشت وضعیت جاری (۲۰۲۶-۰۹-۲۵):** متن و وضعیت بالا رکورد تاریخی زمان تصویب طرح است. P3-01، P3-02 و P3-03 اکنون تا canonical SHA `c69c0d3096c29d902a7fad2009d0b8ec2d4bdf68` یکپارچه‌اند. مالک محصول اجرای bounded بخش P3-04 را صریحاً مجاز کرده است؛ [قرارداد مأموریت P3-04](P3-04-TRANSPORT-EXECUTION-MISSION-CONTRACT-FA.md) و ADR-059 مرز جاری‌اند. این اختیار P3-05، Release، Deployment یا Production را شامل نمی‌شود.
