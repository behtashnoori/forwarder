...
## اثر جاری ادامهٔ P3-11 — ۲۰۲۶-۰۹-۲۶

طبق [اختیار ادامه](phase3/P3-11-RESUME-AUTHORITY.md) و
[قرارداد ETA](phase3/P3-11-ETA-CONTRACT.md)، FWD-J02/J04/J06/J07/J08/J09 و
FWD-IPJ-02/03/04 متأثرند. آزمون برش شامل ورود عادی کارشناس/مشتری، بازکردن ETA
کالای مجاز، بازهٔ بعدی/نهایی مستقل، توقف و unknown، تاریخچه، اصلاح، مرجع نسخه‌دار،
بازگشت و موبایل است. این رکورد فهرست سفرهای حیاتی را تغییر نمی‌دهد و PASS
یکپارچهٔ سراسری یا walkthrough انسانی اعلام نمی‌کند؛ هر دو NOT_RUN می‌مانند.

ارزیابی خودکار همین برش روی Product `c0e35a7845f9749ec574a3e29ed5ec81ada87979` با
[شواهد نهایی](../operational/evidence/phase3-p3-11-eta-status-20260926.md) موفق شد.
این نتیجه فقط P3-11 و بازگشت‌های نام‌برده را پوشش می‌دهد؛ FWD-IPJهای سراسری
و Human Product Walkthrough همچنان NOT_RUN هستند.
