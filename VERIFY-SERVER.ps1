...
if ($manifest.git_tag -ne "v1.9.1" -or $manifest.application_version -ne "1.9.1" -or $manifest.database_revision -ne "20260819_v191_acceptance_corrections" -or $manifest.milestone_type_catalog_apply_status -ne "not applied") { throw "Manifest identity mismatch" }
