...
export function CustomerPortalShipmentDetail() {
  ...
  return <CustomerPortalLayout privateNav><div dir="rtl" className="space-y-5 break-words pb-24 md:pb-0">
    ...
    {loading ? <p role="status">در حال دریافت پرونده حمل…</p> : data && <>
      ...
      <section id="customer-shipment-cargo" aria-labelledby="my-cargo" className="scroll-mt-24 space-y-3"><h2 id="my-cargo" className="text-xl font-bold">کالاهای من</h2><div className="grid gap-3 md:grid-cols-2">{data.cargo.map(item => <Card key={item.public_id}>
