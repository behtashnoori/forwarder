...
export default function OperationalShipments(){
 ...
 const load=(activeFilters=filters)=>{setLoading(true);setError("");const q=new URLSearchParams({...activeFilters,page:String(page)});listOperationalShipments(q.toString()).then(r=>{setRows(r.data);setMore(r.meta.has_more)}).catch(e=>setError(e instanceof ApiError&&e.status===403?t("operations.forbidden"):e instanceof Error?e.message:t("operations.error"))).finally(()=>setLoading(false));};
