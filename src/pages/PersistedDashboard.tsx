...
const supportedSemantics = new Set(["analytics-semantic-v1", "analytics-semantic-v2"]);
...
export default function PersistedDashboard() {
  ...
  if (!supportedSemantics.has(dashboard.semantic_version)) return <State message="این داشبورد به نسخهٔ جدیدتر لایهٔ معنایی نیاز دارد." />;
