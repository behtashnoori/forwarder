...
export default function CargoCatalogAdminTab() {
  ...
  return <div className="space-y-4" dir="auto">
    ...
    <Card><CardHeader><CardTitle>فهرست استاندارد کالاها</CardTitle></CardHeader><CardContent className="space-y-3"><p className="text-sm text-muted-foreground">کالاهای پرتکرار سازمان را یک‌بار با مشخصاتی مانند نام، HS Code، کد قطعه، برند، مدل و واحد پیش‌فرض تعریف کنید تا هنگام ثبت محموله‌ها از اطلاعات استاندارد استفاده شود.</p><div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
